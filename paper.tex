...
\abstract{The Bachelor's Degree is designed to take four years to complete; however, many students fail to complete it this amount of time. One of the factors contributing to this is a lack of proper planning during the registration phase. In this paper we present an algorithm to assist students in constructing a schedule that works towards completing a degree in the shortest amount of time possible.}

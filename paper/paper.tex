...
follows:\\ Maximize: $$ \text{Value of Quarter} = \sum_{i=1}^m Value(c_i) * X_i
$$ Subject To: $$ \sum_{i=1}^m Weight(c_i) * X_i \leq l, $$ $$ \forall t_j \in
O, \sum_{i=1}^m t_j * X_i \leq 1, $$ $$ X_i \in \{0, 1\} $$ The linear program
